 ...
 * started. <br>
 */
public class ParrotPluginService extends Service {
    ...
    private ParrotProtocolClient mClient;
    ...
    public void onCreate() {
        super.onCreate();
        mClient = new ParrotProtocolClient();
    ...
    private ProtocolData getProtocolData() {
        return new ProtocolData(ParrotProtocolClient.PROTOCOL_NAME, getApplicationContext()
    ...
    private Set<DeviceTypeData> getDeviceTypesData() {
        ...
        set.add(new DeviceTypeData(ParrotProtocolClient.DEVICE_TYPE_FLOWERPOWER,
                ParrotProtocolClient.PROTOCOL_NAME, BitmapFactory.decodeResource(getResources(),
                        R.drawable.measure)));

//        set.add(new DeviceTypeData(ParrotProtocolClient.DEVICE_TYPE_LIGHTING,
//                ParrotProtocolClient.PROTOCOL_NAME, BitmapFactory.decodeResource(getResources(),
//                        R.drawable.lighting)));
        return set;
    }
